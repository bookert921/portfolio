...
const A: React.FC<{
  ...
  length: Partial<Record<keyof DOMRef<SVGTextPathElement>, number>>;
  strokeDashoffset: SpringValue<number>;
}> = ({ theme, setRef, length, strokeDashoffset }) => {
  return (
    <animated.path
      data-refkey="A"
      ref={setRef}
      ...
      strokeWidth="4"
      strokeDasharray={length.A}
      strokeDashoffset={strokeDashoffset.to((strokeDashoffset) => {
        if (length.A) {
          return strokeDashoffset * length.A;
        }
        return 0;
      })}
    />
...
const B: React.FC<{
  ...
  return (
    <animated.path
      ...
      stroke={theme.palette.secondary.main}
      strokeWidth="4"
      strokeDasharray={length.B}
      strokeDashoffset={strokeDashoffset.to((strokeDashoffset) => {
        if (length.B) {
          return strokeDashoffset * length.B;
        }
        return 0;
      })}
    />
...
const O: React.FC<{
  ...
  return (
    <animated.path
      ...
      stroke={theme.palette.secondary.main}
      strokeWidth="4"
      strokeDasharray={length.O}
      strokeDashoffset={strokeDashoffset.to((strokeDashoffset) => {
        if (length.O) {
          return strokeDashoffset * length.O;
        }
        return 0;
      })}
    />
...
const U: React.FC<{
  ...
  return (
    <animated.path
      ...
      stroke={theme.palette.secondary.main}
      strokeWidth="4"
      strokeDasharray={length.U}
      strokeDashoffset={strokeDashoffset.to((strokeDashoffset) => {
        if (length.U) {
          return strokeDashoffset * length.U;
        }
        return 0;
      })}
    />
...
const useTextAnimation = () => {
  ...
  return { length, strokeDashoffset, setLength, setRef };
};

const AboutHeader = (props: SVGProps<SVGSVGElement>) => {
  const theme = useTheme();
  const { setRef, setLength, length, strokeDashoffset } = useTextAnimation();
